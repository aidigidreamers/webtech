        ...
        <div data-collapse="medium" data-animation="over-right" data-duration={400} data-doc-height={1} data-no-scroll={1} role="banner" className="navbar native w-nav">
          <div className="container-1800 is--nav">
            <div className="navbar custom">
              ...
              <nav role="navigation" id="w-node-_6be0c6f3-5804-18a3-23b0-d24feef2e7ff-52018772" className="nav-menu w-nav-menu">
                ...
                <div data-hover={1} data-delay={0} className="dropdown w-dropdown">
                  <div className="w-dropdown-toggle">
                    ...
                    <div className="capitals nav-link is--dropdown">Why $BREAST</div>
                  </div>
                  <nav className="dropdown-list w-dropdown-list">
                    <a href="#" className="dropdown-link w-dropdown-link">$BREAST Swap</a>
                    <a href="#" className="dropdown-link _2 w-dropdown-link">$BREAST Swap</a>
                    <a href="#" className="dropdown-link _3 w-dropdown-link">$BREAST Swap</a>
                  </nav>
                </div>
                ...
                <a href="#safebreastx-swap" className="capitals nav-link w-nav-link">swap</a>
              ...
              <a id="w-node-_6be0c6f3-5804-18a3-23b0-d24feef2e80c-52018772" href="https://dex.safebreast.com" target="_blank" className="re-button cta-button is--nav-link w-button">BUY $SAFEBREAST</a>
          ...
          <div className="hero-content-wrapper">
            <div className="_2-col-grid is--hero">
              <div id="w-node-_151b762e-3975-8bd9-09a6-b15858026423-52018772" className="hero-text">
                ...
                <h1 className="display">Breasts safely
                <br /> to the moon</h1>


                <p className="white-text is--hero-text">SafeBreast Inu ($BREAST) is a charity-oriented and community focused decentralized cryptocurrency with instant rewards for charities and holder 🐶</p>
                <div className="hero-buttons">
                  <a href="https://dex.safebreast.com" target="_blank" className="cta-button red-button w-button">BUY $SAFEBREAST</a>
                  <a href="https://drive.google.com/file/d/169iYsSiNTQYnajnBTlyx3OPYzrtlFplK/view" target="_blank" className="chuddar-button cta-button w-button">WHITEPAPER</a>
                </div>
                <div className="social-icons is--hero">
                  <a href="https://t.me/SafeBreast" target="_blank" className="social-icon-item is--hero w-inline-block">
                    <div className="fa-social-icon is--hero"></div>
                  </a>
                   <a href="mailto:admin@safebreast.com" target="_blank" className="social-icon-item is--hero w-inline-block">
                    <div className="fa-social-icon is--hero">✉️
                    </div>
                  </a>
                  <a href="https://twitter.com/SafeBreastInu" target="_blank" className="social-icon-item is--hero w-inline-block">
                    <div className="fa-social-icon is--hero"></div>
                  </a>
...
.</p>
              ...
              <div className="tabs-content w-tab-content">
                <div data-w-tab="Tab 1" className="w-tab-pane w--tab-active">
                  <div className="htb-item">
                    ...
                    <div className="htb-text">
                      ...
                      <p>$BREAST token is available on the Ethereum blockchain. MetaMask is the market leader in ERC20
                ...
                <div data-w-tab="Tab 3" className="w-tab-pane">
                  <div className="htb-item">
                    ...
                    <div className="htb-text">
                      <h4 className="heading-3">Visit SafeBreastX Swap<br /></h4>
                      <p>You can currently buy $BREAST on <a href="https://dex.safebreast.com" target="_blank"><strong>SafeBreastX Swap</strong></a>, SafeBreast's official decentralized exchange
                ...
                <div data-w-tab="Tab 4" className="w-tab-pane">
                  <div className="htb-item">
                    ...
                    <div className="htb-text">
                      <h4 className="heading-3">Swap $ETH for $BREAST<br /></h4>
                      <p>Enter the amount of $ETH you would like to swap for $BREAST. Click <strong>Connect Wallet </strong>
            ...
            <div className="_2-col-grid bottom-padding is--sticky">
              ...
              <div id="w-node-b83854f4-0edc-97bf-60d8-a3002264f576-52018772" className="right-col">
                ...
                <div id="price-chart" data-w-id="911dc789-cd8c-3157-6ceb-b918bd87e7db" className="tokenomics-text-item">
                  <div className="flex-vertical">
                    <h3 id="holders" className="red is--tokenomics">2%+ LIQUIDITY</h3>
                    <h5 className="gray">PER TRANSACTION</h5>
                  </div>
                  <div className="flex-vertical centered">
                    <h3 id="marketcap" className="red is--tokenomics">2% CHARITY</h3>
                    <h5 className="gray">PER TRANSACTION</h5>
                  </div>
                  <div className="flex-vertical">
                    <h3 id="price" className="red is--tokenomics">PRICE CHART</h3>
                    <h5><a href="https://www.dextools.io/app/uniswap/pair-explorer/0x77c1d3cd554b500ee9f2fee41509360f7503257f" target="_blank" className="link">Price Chart</a></h5>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="safebreastx-swap" data-w-id="aaf63f67-334b-e352-4558-ab85d636bd59" className="safebreastx-swap">
        <div className="container-1800">
          ...
          <div className="_2-col-grid is--swap">
            <div id="w-node-_88bfb55d-1e28-bbc5-88fe-35f39f0986a2-52018772" className="safebreastx-swap---text-container">
              ...
              <p className="_w-520">SafeBreastX Swap is our official decentralized exchange (DEX). It gives holders the ability to
              ...
              functionality exclusive to $BREAST holders.</p>
              <a href="https://dex.safebreast.com" target="_blank" className="cta-button red-button w-button">OPEN SafeBreastX</a>
            </div>
            <div data-w-id="144a6b52-a9d9-1231-1db6-5ffa2cee27cf" className="purple-paw-wrapper"><img src="images/purple-paw-2.png" loading="lazy" width={837} sizes="(max-width: 767px) 100vw, (max-width: 1919px) 46vw, 100vw" srcSet="images/purple-paw-2-p-500.png 500w, images/purple-paw-2-p-800.png 800w, images/purple-paw-2.png 837w" alt='pics' className="purple-paw" /><img src="images/screnshot.png" loading="lazy" alt='pics' className="safebreastx-swap-screenshot" /></div>
          </div>
          {/* <div id="w-node-_88bfb55d-1e28-bbc5-88fe-35f39f0986a2-52018772" className="safebreastx-swap---text-container">
            <h5>DECENTRALIZED EXCHANGE</h5>
            <h2>Kishu Swap</h2>
      ...
      <div id="moonmap" className="moonmap">
        <div className="container-1800">
          <div className="section-heading">
            ...
            <p className="_w-660 centered">$BREAST is a coin that wants to engage its community and donate to charity through its different features.. All features currently planned are laid out in the roadmap</p>
          </div>
        </div>
                ...
                <div className="moonmap-phase-wrapper">
                  ...
                  <div className="phase-details">
                    ...
                    <div className="phase-activities">
                      ...
                      <div className="phase-activity-item">
                        <p className="no-bottom-padding">• Passive income dashboard (SafeBreastX Swap)</p>
                      </div>
                    </div>
                  </div>
                </div>
...
<br /></p>
        ...
        <div className="container-1800">
          ...
          <div className="_2-col-grid offset-up">
            ...
            <div className="founding-team-text-wrapper">
              <h2 className="h2-founding-team">Telegram<br />Community</h2>
              <p className="_w-660">
              Feel free to reach out to anyone in the community! We would love to have you. SafeBreast Inu was founded by Chris, he will happily share info about himself with you. Link to his profile in the whitepaper </p>
              <div className="founding-members">
                <div className="founding-member-item">
                  ...
                  <div className="founding-member-text">
                    <h4>Chris</h4>
                    <p>Founder</p>
                    <a href="https://t.me/Chrisli6" target="_blank" className="social-icon-item is--founder w-inline-block">
                ...
                <div className="founding-member-item">
                  ...
                  <div className="founding-member-text">
                    ...
                    <p>Community</p>
                    <a href="https://t.me/SafeBreast" target="_blank" className="social-icon-item is--founder w-inline-block">
                      <div className="fa-social-icon is--founder"></div>
                    </a>
                  </div>
                </div>
        ...
        <div className="container-1800">
          ...
          <div className="_2-col-grid is--donate">
            <div id="w-node-_4cfe832b-f15b-0fee-a5f2-47da4f1898fd-52018772" className="donate-text-wrapper">
              ...
              <p className="_w-520 is--token-code">One In eight women In their lifetime will experience breast cancer. This is something the SafeBreast community cares deeply about. The more transactions on the SafeBreast network the more we are able to raise. Thus, you can help by donating to marketing wallet, or you can donate directly to the charity wallet and the SafeBreast community team will make sure to donate It well on you behalf<br />‍<br /><br /><strong>Accepted</strong>:
              We accept any ERC20 token<br /><strong>Preferred</strong>: $ETH, $USDC, $BREAST</p>
      ...
      <div id="follow" className="footer">
        <div className="footer-relative-wrapper">
          ...
          <div className="logo-and-social-wrapper">
            ...
            <div className="social-icons">
              <a href="https://t.me/SafeBreast" target="_blank" className="social-icon-item w-inline-block">
                <div className="fa-social-icon"></div>
              </a>
              <a href="mailto:admin@safebreast.com" target="_blank" className="social-icon-item w-inline-block">
                <div className="fa-social-icon">✉️
                </div>
              </a>
              <a href="https://twitter.com/SafeBreastInu" target="_blank" className="social-icon-item w-inline-block">
                <div className="fa-social-icon"></div>
              </a>
        ...
        <div className="copyright">
          <p className="white">Copyright © 2021,<strong>Encodix</strong></p>
        </div>
      </div>
    </>
